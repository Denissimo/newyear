...
<nav class="navbar navbar-pink">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="/"><img src="/imag/back/logo2.png" /></a>
    </div>
...
<div class="goodunit goodunit-pink">
...
<div class="row mart5">
	<div class="col-md-6 col-md-offset-1 price-pink">
	7450&nbsp;&#8381;
	</div>
	<div class="col-md-4">
		<form action="[{post}]" method="post">
		<input type="hidden" name="good_id" value="[>good_id<]">
		<input type="submit" name="good2basket" class="btn btn-pink" value="Заказать">
		</form>
	</div>
</div>
