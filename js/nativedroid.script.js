	...
	nativeDroid = {
			...
			dateFormat : {
				language : {
					...
					ru : {
						...
						dayLong : ["Воскресение", "Понедельник", "Вторник", "Среда", "Четверг", "Пятница", "Суббота"],
		...
		design : {
			...
			progress : {
				...
				blink : function() {
					$(".nativeDroidProgress").fadeTo(0, 0.5, function() {
						$(".nativeDroidProgress").fadeTo(0, 1);
					});
				},
		...
		plugins : {
			...
			twitter : {
				...
				refresh : {
					...
					auto_delay : 45000,
					load : function() {
						nativeDroid.design.progress.update(nativeDroid.plugins.twitter.refresh.time / 10);
